    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='App_1.site')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auto_value', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='automatic value')),
                ('confirmed_value', models.DecimalField(decimal_places=3, max_digits=10)),
                ('occurrence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_1.occurrence')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='App_1.metrictype')),
            ],
            options={
                'verbose_name': 'Metric',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurrence', models.ManyToManyField(to='App_1.occurrence')),
                ('site', models.ManyToManyField(to='App_1.site')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'File',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_1.attributecategory')),
            ],
            options={
