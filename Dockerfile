...
RUN mkdir -p /usr/src/geonode_odyssey
...
COPY src /usr/src/geonode_odyssey/
WORKDIR /usr/src/geonode_odyssey
...
RUN chmod +x /usr/src/geonode_odyssey/tasks.py \
    && chmod +x /usr/src/geonode_odyssey/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonode_odyssey/entrypoint.sh
